...
const ApprovedDayoffDialog = ({ children }: PropsWithChildren) => {
            ...
            switch (alterDayoff.status) {
              case "idle":
                return (
                  <>
                    <Container>
                      <Text shape="T15_700">휴가를 승인하시겠습니까?</Text>
                    </Container>
                    <HStack>
              ...
              case "success":
                return (
                  <>
                    <Container>
                      <Text shape="T15_700">휴가가 승인되었습니다.</Text>
                    </Container>
                    <Alert.Cancel asChild>
                      <ButtonImpl
                        onClick={() => {
...
export default ApprovedDayoffDialog;
